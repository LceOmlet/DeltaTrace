...
struct Flash_fwd_kernel_traits : public Base {
    ...
    using GmemTiledCopyRotcossinCont = decltype(make_tiled_copy(Copy_Atom<DefaultCopy, Element>{},
                                                                GmemLayoutAtomRotcossin{}, Layout<Shape<_1, _8>>{}));
};
...
struct Flash_bwd_kernel_traits : public Base {
    ...
    using SmemLayoutAtomKV_hdim64 = decltype(composition(
        Swizzle<3, 3, 3>{}, Layout<Shape<Int<kBlockM / kNWarps>, Int<kBlockKSmem>>, Stride<Int<kBlockKSmem>, _1>>{}));
    ...
    using SmemLayoutAtomKtransposed_hdim64 =
        decltype(composition(Swizzle<3, 3, 3>{}, SmemLayoutAtomKtransposedNoSwizzle{}));
    ...
    using SmemLayoutAtomPdS = decltype(composition(
        Swizzle<0, 0, 0>{}, Layout<Shape<Int<kBlockM>, Int<kPBlockN>>, Stride<Int<kPBlockN>, _1>>{}));
    ...
    using GmemTiledCopydQ =
        decltype(make_tiled_copy(Copy_Atom<DefaultCopy, elem_type>{}, GmemLayoutAtom{}, Layout<Shape<_1, _8>>{}));
    using GmemLayoutAtomdQaccum = std::conditional_t<kBlockKSmem == 32, Layout<Shape<_32, _8>, Stride<_8, _1>>,
                                                     Layout<Shape<_16, _16>, Stride<_16, _1>>>;
    using GmemTiledCopydQaccum = decltype(make_tiled_copy(Copy_Atom<DefaultCopy, ElementAccum>{},
                                                          GmemLayoutAtomdQaccum{}, Layout<Shape<_1, _4>>{}));

    using GmemTiledCopydQaccumAtomicAdd = decltype(make_tiled_copy(
        Copy_Atom<DefaultCopy, ElementAccum>{}, Layout<Shape<_8, _32>, Stride<_32, _1>>{}, Layout<Shape<_1, _1>>{}));
    ...
    using SmemLayoutAtomKVSwizzle = decltype(composition(
        Swizzle<2, 2, 4>{}, Layout<Shape<Int<kBlockM / kNWarps>, Int<kBlockKSmem>>, Stride<Int<kBlockKSmem>, _1>>{}));
    ...
    using GmemTiledCopyQKV_hdim128 = decltype(make_tiled_copy(
