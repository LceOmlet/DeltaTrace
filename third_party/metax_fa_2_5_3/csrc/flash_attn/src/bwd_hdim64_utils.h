...
inline __device__ void shuffle_neighbouring(uint32_t &v) {
...
inline __device__ void trans(uint32_t &a, uint32_t &b) {
...
inline __device__ void sts_transpose(const Tensor<Engine, Layout> &tensor, void *sts_ptr0, void *sts_ptr1,
    ...
    *(reinterpret_cast<uint64_t *>(sts_ptr1)) = *(reinterpret_cast<uint64_t *>(tmp));
    ...
    tmp[1] = src_ptr[5];
    trans(tmp[0], tmp[1]);
    *(reinterpret_cast<uint64_t *>(sts_ptr2)) = *(reinterpret_cast<uint64_t *>(tmp));

    tmp[0] = src_ptr[6];
    tmp[1] = src_ptr[7];
    trans(tmp[0], tmp[1]);
    *(reinterpret_cast<uint64_t *>(sts_ptr3)) = *(reinterpret_cast<uint64_t *>(tmp));
}

template <typename Engine, typename Layout>
inline __device__ void lds_transpose(Tensor<Engine, Layout> &tensor, void *sts_ptr0, void *sts_ptr1, void *sts_ptr2,
                                     void *sts_ptr3) {
    auto dst_ptr = tensor.data();
    uint32_t tmp[2];

    auto src_ptr = reinterpret_cast<uint32_t *>(sts_ptr0);
    tmp[0] = src_ptr[0];
    tmp[1] = src_ptr[1];
    trans(tmp[0], tmp[1]);
    *(reinterpret_cast<uint64_t *>(dst_ptr)) = *(reinterpret_cast<uint64_t *>(tmp));

    src_ptr = reinterpret_cast<uint32_t *>(sts_ptr1);
    tmp[0] = src_ptr[0];
    tmp[1] = src_ptr[1];
    trans(tmp[0], tmp[1]);
    *(reinterpret_cast<uint64_t *>(dst_ptr + 4)) = *(reinterpret_cast<uint64_t *>(tmp));

    src_ptr = reinterpret_cast<uint32_t *>(sts_ptr2);
    tmp[0] = src_ptr[0];
    tmp[1] = src_ptr[1];
    trans(tmp[0], tmp[1]);
    *(reinterpret_cast<uint64_t *>(dst_ptr + 8)) = *(reinterpret_cast<uint64_t *>(tmp));

    src_ptr = reinterpret_cast<uint32_t *>(sts_ptr3);
    tmp[0] = src_ptr[0];
    tmp[1] = src_ptr[1];
    trans(tmp[0], tmp[1]);
...
template <typename Tensor0, typename Tensor1, typename Tensor2, typename TiledMma, typename Element>
__forceinline__ __device__ void gemm_A_in_reg(Tensor0 &acc, Tensor1 &tCrA, Tensor2 &tCrB, Element *ldsB_ptr0,
                                              Element *ldsB_ptr1, Element *ldsB_ptr2, Element *ldsB_ptr3,
                                              TiledMma tiled_mma) {
    CUTE_STATIC_ASSERT_V(size<1>(tCrA) == size<1>(acc));
    CUTE_STATIC_ASSERT_V(size<1>(tCrB) == size<2>(acc));
    CUTE_STATIC_ASSERT_V(size<2>(tCrA) == size<2>(tCrB));

    *(reinterpret_cast<uint64_t *>(tCrB.data())) = *(reinterpret_cast<uint64_t *>(ldsB_ptr0 + 0 * 16 * 64));
    *(reinterpret_cast<uint64_t *>(tCrB.data() + 4)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr0 + 1 * 16 * 64));
    *(reinterpret_cast<uint64_t *>(tCrB.data() + 8)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr0 + 2 * 16 * 64));
    *(reinterpret_cast<uint64_t *>(tCrB.data() + 12)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr0 + 3 * 16 * 64));

    *(reinterpret_cast<uint64_t *>(tCrB.data() + 16)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr1 + 0 * 16 * 64));
    *(reinterpret_cast<uint64_t *>(tCrB.data() + 20)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr1 + 1 * 16 * 64));
    *(reinterpret_cast<uint64_t *>(tCrB.data() + 24)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr1 + 2 * 16 * 64));
    *(reinterpret_cast<uint64_t *>(tCrB.data() + 28)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr1 + 3 * 16 * 64));

    __builtin_mxc_schedbound_begin();
    cute::gemm(tiled_mma, tCrA(_, _, _0{}), tCrB(_, _, _0{}), acc);
    __builtin_mxc_schedbound_end();

    *(reinterpret_cast<uint64_t *>(tCrB.data() + 32)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr2 + 0 * 16 * 64));
    *(reinterpret_cast<uint64_t *>(tCrB.data() + 36)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr2 + 1 * 16 * 64));
    *(reinterpret_cast<uint64_t *>(tCrB.data() + 40)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr2 + 2 * 16 * 64));
    *(reinterpret_cast<uint64_t *>(tCrB.data() + 44)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr2 + 3 * 16 * 64));

    __builtin_mxc_schedbound_begin();
    cute::gemm(tiled_mma, tCrA(_, _, _1{}), tCrB(_, _, _1{}), acc);
    __builtin_mxc_schedbound_end();

    *(reinterpret_cast<uint64_t *>(tCrB.data() + 48)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr3 + 0 * 16 * 64));
    *(reinterpret_cast<uint64_t *>(tCrB.data() + 52)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr3 + 1 * 16 * 64));
    *(reinterpret_cast<uint64_t *>(tCrB.data() + 56)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr3 + 2 * 16 * 64));
    *(reinterpret_cast<uint64_t *>(tCrB.data() + 60)) = *(reinterpret_cast<uint64_t *>(ldsB_ptr3 + 3 * 16 * 64));
