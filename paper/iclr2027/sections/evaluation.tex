...
Table~\ref{tab:qwen35-quality} compares DT and FT on eight tasks comprising 72 examples: ten new key/value assignments for each of six NIAH tasks, plus six released examples each from MATH and MoreHopQA. DT achieves higher Recall on all six NIAH tasks, lower RISE on six of eight tasks, and lower MAS on seven. On MATH and MoreHopQA, DT lowers both RISE and MAS.
