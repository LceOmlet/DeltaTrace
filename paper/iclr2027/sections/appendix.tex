...
Every method has one warm call followed by three measured calls in rotated order on each of 16 development examples. Aggregate times sum the per-example medians. Across examples, the ratio of DT to one-hop FT time has median 0.928, interquartile range 0.880--1.008, and full range 0.758--1.405; DT is faster on 11 of 16 examples. Three-hop FT totals 18.27 seconds.
