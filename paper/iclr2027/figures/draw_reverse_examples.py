...
def draw_overview_top(ax):
    ...
    text(125, 311, r'Displacement $\Delta e_i$', 21.5, blue, 'bold')
    text(335, 311, 'Effective secant slopes', 20.4, purple, 'bold')
    text(69, 336, 'Token')
    text(69, 358, 'vector')
    text(180, 336, 'EOS')
    text(180, 358, 'vector')
    ...
    text(227, 429, r'Displacement $\times$ slope; sum within token')
    ...
    text(631,454,'Value, key, gate slopes',20.4,purple)
    text(865,454,'Query slopes',20.4,purple)
    return texts
