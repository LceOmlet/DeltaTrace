...
def main():
    ...
    try:
        ...
        from qwen3_root_safe_cast import propagate_root_tape as propagate_cast
            ...
            def make_runner():
                ...
                def call():
                    ...
                    if args.family=='qwen3':
                        ...
                        tape=(LocalNativeRootTape if mode in ('root_local','root_compiled','root_rope','root_safe_cast') else NativeRootTape)(model,mutation_audit=phase=='audit')
                        try:
                            with tape:before,after=capture_checkpoint_pair(model,base_ids,actual,attention,p_len)
                            compiled_fa.audit_inputs=phase=='audit'
                            if mode=='root_safe_cast':return propagate_cast(model,before,after,tape,pv_rule='content_P1',finite_attention=compiled_fa)
                ...
                return call
            modes=['retained','root_rope','root_safe_cast']
