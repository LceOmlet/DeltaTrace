            ...
            def make_runner():
                ...
                def call():
                    ...
                    if args.family=='qwen3':
                        ...
                        tape=(LocalNativeRootTape if mode in ('root_local','root_compiled') else NativeRootTape)(model,mutation_audit=phase=='audit')
                        try:
                ...
                return call
            modes=['retained','root_local','root_compiled']
