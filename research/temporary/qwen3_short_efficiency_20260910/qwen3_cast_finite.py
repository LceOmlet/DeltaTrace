from qwen3_cast_boundaries import attention_layout, norm_residual_two, norm_residual_three, qk_norms
...
from qwen3_cast_boundaries import norm as rmsnorm_secant_pullback
