    ...
    try:
        ...
        for input_len in map(int,args.lengths.split(',')):
            ...
            def make_runner():
                ...
                def call():
                    ...
                    if args.family=='qwen3':
                        ...
                        try:
                            ...
                            return (propagate_batched_root_tape if mode=='root_batched' else propagate_root_tape)(model,before,after,tape,pv_rule='content_P1',finite_attention=finite_fa)
                        finally:tape.clear()
                ...
                return call
            modes=['retained','root_tape','root_batched']
