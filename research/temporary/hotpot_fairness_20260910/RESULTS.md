...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| 删前缀后答案 | 官方 ID，恢复正文坐标 | 48 | 68.58 | 66.15 | +2.43 | [-6.77, +12.15] |
| 删前缀后答案 | 另修订两处关系标签 | 48 | 68.58 | 67.19 | +1.39 | [-7.64, +10.76] |
...
| 删前缀后答案 | 原始词元排序 + 缓存标签 | 41.01 | 37.83 | +3.18 |
| 删前缀后答案 | 原始排序 + 正文坐标修正 | 41.01 | 37.83 | +3.18 |
| 删前缀后答案 | 旧正则句均值 + 缓存标签 | 65.80 | 60.94 | +4.85 |
| 删前缀后答案 | 旧正则句均值 + 正文坐标修正 | 65.80 | 60.94 | +4.85 |
| 删前缀后答案 | 再修正前导空格归属 | 67.37 | 61.78 | +5.60 |
| 删前缀后答案 | 再使用原生句边界（仍按词元截断） | 65.37 | 61.51 | +3.86 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 删前缀后答案 | DT | 39.64 | 68.58 | 47.58 | 6.25 | 33.33 | 114.71 | 2.92 | 5.02 |
| 删前缀后答案 | FT K1 | 39.00 | 65.45 | 46.45 | 2.08 | 27.08 | 114.00 | 3.62 | 4.92 |
| 删前缀后答案 | FT K3 | 41.12 | 66.15 | 47.78 | 2.08 | 29.17 | 114.10 | 3.52 | 4.83 |
...
| --- | --- | ---: | ---: | ---: | --- |
| 删前缀后答案 | 官方 ID，恢复正文坐标 | 69.26 | 68.33 | +0.93 | [-6.67, +8.52] |
| 删前缀后答案 | 另修订两处关系标签 | 69.26 | 69.44 | -0.19 | [-7.41, +7.22] |
