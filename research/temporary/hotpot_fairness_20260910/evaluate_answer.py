...
def arguments(argv=None):
    ...
    parser.add_argument('--stage', choices=['fairness'], required=True)
...
def main():
    ...
    report.update(experiment='hotpot-answer-fairness-v2', stage=args.stage, chunk=args.chunk, indices=plan['chunks'][args.chunk], fair_plan_sha256=sha((FAIR/'protocol.json').read_bytes()), plan_sha256=split['plan_sha256'], choice=choice)
    vectors = {}
