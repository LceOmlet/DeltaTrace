...
p=argparse.ArgumentParser();p.add_argument('--phase',choices=['fa_all_cached'],required=True);a=p.parse_args();root=Path(__file__).resolve().parent;folder=root/a.phase
