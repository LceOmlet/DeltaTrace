        ...
        if is_dt:
            ...
            if args.family=='qwen3':
                ...
                if args.method=='deltatrace_streamed':
                    from whole_sac_lifetime_v3 import SACFiniteGraphQwen3
                    from vendor_fa_finite_shared_mean_reuse_runtime import VendorFAFiniteP1SharedMeanReuse
                    candidate_fa=VendorFAFiniteP1SharedMeanReuse(protocol['candidate_finite_library']['path'],protocol['candidate_finite_library']['sha256'])
                    dt_runner=SACFiniteGraphQwen3(model,candidate_fa)
