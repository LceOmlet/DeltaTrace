...
from whole_exact_target_head_base import WholeProgram,WholeRematFiniteGraphQwen3,root_endpoints,LiveScoresPacked
from native_projection_sac_v4 import NativeProjectionReuse
...
from remat_finite_lifetime_v4 import propagate_signed_secant


class SACProgram(WholeProgram):
    from persistent_graph_build_v2 import build
    def invoke(self):
        self.inputs=None
        n=self.ids.shape[1]
