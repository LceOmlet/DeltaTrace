...
p=argparse.ArgumentParser();p.add_argument('--phase',choices=['fa_owner64_warps4'],required=True);a=p.parse_args();root=Path(__file__).resolve().parent;folder=root/a.phase
