...
p=argparse.ArgumentParser();p.add_argument('--phase',choices=['fa_template'],required=True);a=p.parse_args()
...
names=['result_template_v1.py','result_template_graph.py','benchmark_'+a.phase+'.py',a.phase+'_protocol.json',a.phase+'.log','collect_fa_template.py']
