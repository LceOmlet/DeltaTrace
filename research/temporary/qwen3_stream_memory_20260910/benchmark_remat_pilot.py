        ...
        if is_dt:
            ...
            if args.family=='qwen3':
                ...
                if args.method=='deltatrace_streamed':
                    from remat_qwen3_graph import RematFiniteGraphQwen3
                    dt_runner=RematFiniteGraphQwen3(model,dt_runner.finite)
            ...
            def make_runner():
                ...
                def call():
                    ...
                    if args.family=='qwen3':
                        ...
                        last_cost.clear();last_cost.update({k:answer.get(k) for k in ['streamed_root','rematerialized_root','native_graph_execution','root_retention_mutation_audit','graph_input_copy_audit']})
                        return answer
