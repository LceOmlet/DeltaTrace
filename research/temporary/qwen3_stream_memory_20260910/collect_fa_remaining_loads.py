...
p=argparse.ArgumentParser();p.add_argument('--phase',choices=['fa_all64_cached','fa_mma_owner'],required=True);a=p.parse_args();root=Path(__file__).resolve().parent;folder=root/a.phase
