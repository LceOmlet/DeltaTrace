        ...
        if is_dt:
            ...
            if args.family=='qwen3':
                ...
                if args.method=='deltatrace_streamed':
                    ...
                    import streamed_qwen3
                    assert sha(Path(streamed_qwen3.__file__).read_bytes())==protocol['candidate_sha256']
                    dt_runner=streamed_qwen3.StreamedFiniteGraphQwen3(model,dt_runner.finite)
        ...
        for input_len in map(int,args.lengths.split(',')):
            ...
            def make_runner():
                ...
                def call():
                    ...
                    if args.family=='qwen3':
                        return dt_runner.attribute(base_ids,actual,attention,p_len,mutation_audit=phase=='audit')
            ...
            for rep in range(n_runs):
                ...
                row={'family':args.family,'attr_func':args.method,'phase':phase,'repeat':rep,
                  ...
                  'input_sha256':expected_hash,'resident_before':resident_before,'resident_after':resident_after,'process_memory':process_memory}
