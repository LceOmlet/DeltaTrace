...
from symmetric_secant import propagate_signed_secant

def propagate_paired_secant(model,before,after,progress=None,pv_rule='content_P1',activity=None,finite_attention=None,finite_activity=None,target_weights=None):
    ...
    try:
        result=propagate_signed_secant(model,left,right,'rescale',progress=progress,pv_rule=pv_rule,
            finite_attention=finite_attention,finite_activity=finite_activity,target_weights=target_weights)
