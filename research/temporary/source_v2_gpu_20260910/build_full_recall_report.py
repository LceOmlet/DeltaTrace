...
def main():
    ...
    if a.plot:
        ...
        fig.legend(handles,legend_labels,loc='lower center',bbox_to_anchor=(.53,.06),ncol=3,frameon=False,fontsize=9)
        ...
        fig.subplots_adjust(left=.065,right=.98,bottom=.27,top=.82,wspace=.16)
