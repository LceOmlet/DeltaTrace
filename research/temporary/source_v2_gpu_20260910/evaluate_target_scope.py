...
def arguments(argv=None):
    ...
    parser.add_argument('--stage', choices=['validation'], required=True)
...
def main():
    ...
    report.update(experiment='target-scope-v1', stage=args.stage, split_sha256=sha((PILOT / 'scope_split.json').read_bytes()), plan_sha256=split['plan_sha256'], choice=choice)
    vectors = {}
