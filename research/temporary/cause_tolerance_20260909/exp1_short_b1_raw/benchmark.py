...
def main():
    ...
    report={'status':'imports','family':args.family,'method':args.method,
      'driver_sha256':sha(Path(__file__).read_bytes()),'protocol_sha256':sha((A/'benchmark_protocol.json').read_bytes()),
    ...
    try:
        ...
        for input_len in map(int,args.lengths.split(',')):
            ...
            for rep in range(n_runs):
                phase='original3' if rep<3 else 'warm3'
