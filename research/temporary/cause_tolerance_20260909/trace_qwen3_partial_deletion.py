...
def main():
    ...
    from qwen3_trace_pair import propagate_paired_secant as instrument
    ...
    derivation = json.loads((Path(__file__).parent/'qwen3_trace_derivation.json').read_bytes())
    ...
    try:
        ...
        for row in rows:
            ...
            class Observer:
                ...
                def decoder(self,index,raw,mout,minput,mmid,ma_parts,mn_parts):
