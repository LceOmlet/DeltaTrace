...
|---|---:|---:|---:|---:|---:|
| 128 | 157 | 502.1 | 323.8 | -35.51% | 19.172 |
| 256 | 264 | 529.3 | 332.5 | -37.19% | 19.362 |
| 512 | 477 | 569.1 | 453.9 | -20.24% | 19.741 |
| 1024 | 904 | 799.5 | 803.3 | +0.47% | 20.503 |

![完整调用对比](code_local_latency.png)
...
|---|---:|---|
| morehopqa_0 | 869 | 完全相同 |
| morehopqa_1 | 368 | 完全相同 |
| morehopqa_2 | 726 | 完全相同 |
| morehopqa_3 | 773 | 完全相同 |
| morehopqa_4 | 753 | 完全相同 |
| morehopqa_5 | 362 | 完全相同 |
| morehopqa_6 | 432 | 完全相同 |
| morehopqa_7 | 533 | 完全相同 |
| niah_mq_q2_0 | 605 | 完全相同 |
| niah_mq_q2_3 | 590 | 完全相同 |
| niah_mq_q2_6 | 612 | 完全相同 |
...
合计 90 次完整计时/剖析调用（121.603 秒），23 次单独输出核验（10.844 秒），22 次真实作者短样本兼容性调用（97.903 秒）。模型加载 64.369 秒、原生 eager 初始化 67.341 秒另列。首次两次 profile 导入失败未进行模型调用，日志保留。
