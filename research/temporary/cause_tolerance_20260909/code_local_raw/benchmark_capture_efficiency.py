...
def main():
    ...
    report={'status':'imports','family':args.family,'method':args.method,
      ...
      'warm_timing_scope':'Additional three direct calls after the original three, for DT and the two FT variants only. Same author reset/empty_cache before every call.',
    ...
    try:
        ...
        from capture_efficiency_candidates import CaptureEfficiency
