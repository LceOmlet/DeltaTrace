...
class NativeMLPSelectiveReuse:
    def __init__(self, model, activity, first_cached_layer=0):
        import torch
        ...
        assert isinstance(first_cached_layer, int) and 0 <= first_cached_layer < len(model.model.layers)
        ...
        activity.update(public_API='torch.utils.checkpoint.create_selective_checkpoint_contexts',
            ...
            allow_cache_entry_mutation=False, first_cached_layer=first_cached_layer, regions=[], saved_mm_outputs=0,
