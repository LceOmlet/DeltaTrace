ATTENTION_OBSERVER=None
from compiled_secant_boundaries import midpoint, scaled_probability, attention_layout, norm_residual_two, norm_residual_three
