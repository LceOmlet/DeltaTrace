...
try:
    ...
    remaining_pairs=[['niah_mq_q2_2', 'morehopqa_1'], ['niah_mq_q2_1', 'morehopqa_0'], ['niah_mq_q2_3', 'morehopqa_3']]
    assert type(p['segment_index']) is int and 0<=p['segment_index']<3
    ...
    r['completion_scope']='Only the selected fixed two-case input-supported GDN1 K segment; no other cases dispatched or claimed complete for this candidate.'
