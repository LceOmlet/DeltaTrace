...
def provenance(D,p,r,receipt,complete):
    ...
    frozen='dt_GDN1_K_whole_pilot_protocol_20260909.json'
...
if __name__=='__main__':
    result=audit(A/'snapshot${ARTIFACT_ROOT}/codex_dt_GDN1_K_whole_pilot_20260909_v1')
    target=A/'dt_GDN1_K_whole_pilot_summary_20260909.json';target.write_text(json.dumps(result,indent=2,allow_nan=False))
