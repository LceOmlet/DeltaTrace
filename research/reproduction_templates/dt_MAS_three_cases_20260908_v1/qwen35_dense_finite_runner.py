...
class Qwen35DenseFiniteRunner:
    def __init__(self,model,finite_fa,finite_fla):
    ...
    def attribute(self,paired_ids,mask,selection,select_output_rows=False):
        ...
        def final_norm(_module,args,output):root['final_norm_input']=_copy(args[0],'cpu')
        ...
        effect_G=float((lp1.double()-lp0.double()).sum())
        ...
        info={'select_output_rows':select_output_rows,'complete_attribution_seconds_with_diagnostics':seconds,
              ...
              'calls':calls,'layers':ledger,'target_logp0':lp0.tolist(),'target_logp1':lp1.tolist()}
        return signed,info
