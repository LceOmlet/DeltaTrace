"""Fixed MH0/NI1 layer19 content0 PV pilot;4DT100FLA84originalscores."""
...
try:
    ...
    r['vectors_sha256']=sha((A/'vectors.npz').read_bytes());r['status']='layer19_PV_content0_current_layer0_4DT100FLA84score_complete'
