...
class Qwen35DenseFiniteRunner:
    def __init__(self,model,finite_fa,finite_fla,*,norm_gate_rules=None,finite_fla_by_layer=None,attention_pv_rules=None):
        ...
        Optional attention_pv_rules selects content1/content0/symmetric at existing FA
        ...
        for index,rule in self.attention_pv_rules.items():
            ...
            if not isinstance(rule,str) or rule not in ('content1','content0','symmetric'):
