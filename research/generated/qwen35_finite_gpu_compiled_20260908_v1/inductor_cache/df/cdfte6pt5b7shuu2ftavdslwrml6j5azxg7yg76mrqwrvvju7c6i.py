...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/kk/ckk2gpd4nyxosgsuaijxvc6k5pi4ppusal3tav5xyalyt6t2runp.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/hh/chh4yuohwadqcwsobbw744xnfsoydqf2lcysu3dgwmdlfxtzixvu.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_constant_pad_nd_1', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'F4337AF59E18A006A8110C1F352F0F4EB3D3AA586F5B0DB6F6A950B0D9B8F3BC', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': False, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 1572864, 'x': 3145728}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/mv/cmvg236ll6vfnhemr3u2aqihvr76i6bi4muntl4qqduhhdlt3zm6.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*bf16', 'ynumel': 'i32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='maca', index=0, multi_processor_count=104, cc=80, major=8, regs_per_multiprocessor=131072, max_threads_per_multi_processor=2048, warp_size=64), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_constant_pad_nd_2', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'F4337AF59E18A006A8110C1F352F0F4EB3D3AA586F5B0DB6F6A950B0D9B8F3BC', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': False, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 3145728, 'x': 6291456}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/zc/czceqoawimoy6rxsvcrwed3tqgzms7uqmyjs64i5o3llaew4bx6j.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*bf16', 'ynumel': 'i32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='maca', index=0, multi_processor_count=104, cc=80, major=8, regs_per_multiprocessor=131072, max_threads_per_multi_processor=2048, warp_size=64), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_constant_pad_nd_3', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'F4337AF59E18A006A8110C1F352F0F4EB3D3AA586F5B0DB6F6A950B0D9B8F3BC', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': False, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 3145728, 'x': 6291456}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_constant_pad_nd_3(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 12288
    xnumel = 128
    yoffset = tl.program_id(1) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/ix/cix7h5oxhnib3jh34dna3d6ial62h3f5kkcu6ialaqkqsjdhd57z.py
# Topologically Sorted Source Nodes: [a_23], Original ATen: [aten.constant_pad_nd]
# Source node to ATen node mapping:
#   a_23 => constant_pad_nd_9
# Graph fragment:
#   %constant_pad_nd_9 : [num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%permute_12, [0, 0, 0, 63], 0.0), kwargs = {})
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/ed/cedp76ruqxzb5vhkhnkjfelpqwvnnjmkkycl2iwm2yblazli2p7s.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/wf/cwfsjwfusomkah6rbzy23uk3eudrt7hwi47biwa6srvy6zulg636.py
# Topologically Sorted Source Nodes: [W, to_5, to_22], Original ATen: [aten.mul, aten._to_copy]
# Source node to ATen node mapping:
#   W => mul
#   to_22 => convert_element_type_29
...
#   %convert_element_type_29 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul, torch.bfloat16), kwargs = {})
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/7b/c7bapju3fc4dwcgb3ruwnd3nhvgcbynxyg55ldhuzixso4damg5g.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/hz/chz6qm76juh5veejf6ffrqhnwmjeljvpemsihpak6lbaeaox4eem.py
...
#   %mul_20 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_41, %convert_element_type_42), kwargs = {})
#   %sum_3 : [num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_20, [-1, -2]), kwargs = {})
triton_per_fused__to_copy_mul_sum_8 = async_compile.triton('triton_per_fused__to_copy_mul_sum_8', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_mul_sum_8', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'F4337AF59E18A006A8110C1F352F0F4EB3D3AA586F5B0DB6F6A950B0D9B8F3BC', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': False, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 1536, 'r0_': 384}}
)
@triton.jit
def triton_per_fused__to_copy_mul_sum_8(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 192
    r0_numel = 2
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/o5/co5ntnmtbgn2uous2wpp5ftdylj564d4n4pssu6ocuc3uwl7m6up.py
...
triton_per_fused__to_copy_constant_pad_nd_mul_sum_9 = async_compile.triton('triton_per_fused__to_copy_constant_pad_nd_mul_sum_9', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_constant_pad_nd_mul_sum_9', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 1, 'backend_hash': 'F4337AF59E18A006A8110C1F352F0F4EB3D3AA586F5B0DB6F6A950B0D9B8F3BC', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': False, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 98304, 'r0_': 15728640}}
)
@triton.jit
def triton_per_fused__to_copy_constant_pad_nd_mul_sum_9(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 12288
    r0_numel = 128
    ...
    tmp1 = tl.full([1, 1], 129, tl.int64)
    tmp2 = tmp0 < tmp1
    tmp3 = tl.load(in_ptr0 + (r0_3 + 128*x1 + 4096*x0 + 528384*x2), tmp2, other=0.0).to(tl.float32)
    tmp4 = tmp3.to(tl.float32)
    tmp6 = tmp4 * tmp5
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/43/c43gwu47faye3axej4dp4kktav32su57wr3udaiieexs6sbsuowd.py
# Topologically Sorted Source Nodes: [sub, clamp_max, exp, causal, E0, mul_4, to_14, lower, mul_14, mul_15, to_24, mul_17, mul_18, to_28], Original ATen: [aten.sub, aten.clamp_max, aten.exp, aten.ge, aten.mul, aten._to_copy, aten.gt]
# Source node to ATen node mapping:
#   E0 => mul_1
#   causal => ge
#   clamp_max => clamp_max
...
#   %mul_4 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%permute_21, %mul_1), kwargs = {})
#   %convert_element_type_16 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_4, torch.bfloat16), kwargs = {})
...
triton_poi_fused__to_copy_clamp_max_exp_ge_gt_mul_sub_10 = async_compile.triton('triton_poi_fused__to_copy_clamp_max_exp_ge_gt_mul_sub_10', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/5k/c5knsp7rsmuqtvhhrlod3xj3zf5fy4bhuxezvk6refcabdjivib4.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_11', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': 'F4337AF59E18A006A8110C1F352F0F4EB3D3AA586F5B0DB6F6A950B0D9B8F3BC', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': False, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'y': 8454144, 'x': 16908288}},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_clone_11(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 64
    xnumel = 16512
    yoffset = tl.program_id(1) * YBLOCK
    yindex = yoffset + tl.arange(0, YBLOCK)[:, None]
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/k3/ck37juyay67sveriy76dsyld6j3i2y2ddtvfdi4yf2lmen5ug4im.py
# Topologically Sorted Source Nodes: [triton_kernel_wrapper_mutation, sub_1, clamp_max_1, exp_1, E1, mul_7, to_18, mul_9, to_20], Original ATen: [aten.sub, aten.clamp_max, aten.exp, aten.mul, aten._to_copy]
# Source node to ATen node mapping:
#   E1 => mul_2
...
#   %convert_element_type_21 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_7, torch.bfloat16), kwargs = {})
#   %mul_9 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_2, %mul_2), kwargs = {})
#   %convert_element_type_24 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_9, torch.bfloat16), kwargs = {})
triton_poi_fused__to_copy_clamp_max_exp_mul_sub_12 = async_compile.triton('triton_poi_fused__to_copy_clamp_max_exp_mul_sub_12', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/ne/cnehtmqcxu3y2h65lld6zrsuhmplsru2tqkiuio42mlfoptauaq2.py
...
#   float_6 => convert_element_type_28
...
#   %mul_8 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_9, 0.08838834764831845), kwargs = {})
#   %add_1 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_6, %mul_8), kwargs = {})
#   %sub_3 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_1, %bmm_10), kwargs = {})
#   %convert_element_type_27 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_2, torch.float32), kwargs = {})
#   %mul_10 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_11, %convert_element_type_27), kwargs = {})
#   %convert_element_type_28 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_4, torch.float32), kwargs = {})
#   %mul_11 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_28, %bmm), kwargs = {})
...
#   %mul_13 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_13, %bmm_11), kwargs = {})
...
triton_red_fused__to_copy_add_mul_sub_sum_13 = async_compile.triton('triton_red_fused__to_copy_add_mul_sub_sum_13', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_mul_sub_sum_13', 'mutated_arg_names': ['in_out_ptr0', 'in_out_ptr1'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 29, 'num_reduction': 4, 'backend_hash': 'F4337AF59E18A006A8110C1F352F0F4EB3D3AA586F5B0DB6F6A950B0D9B8F3BC', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': False, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 3686400, 'r0_': 81788928}}
)
@triton.jit
def triton_red_fused__to_copy_add_mul_sub_sum_13(in_out_ptr0, in_out_ptr1, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, in_ptr9, in_ptr10, in_ptr11, in_ptr12, in_ptr13, out_ptr0, out_ptr1, out_ptr4, out_ptr5, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 12288
    r0_numel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp18 = tl.load(in_ptr3 + (tl.broadcast_to(4128 + 32*((x2 % 192)) + 8256*(x2 // 6144) + (((x2 // 192) % 32)), [XBLOCK, R0_BLOCK])), r0_mask & tmp4, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tmp31 = tl.load(in_ptr6 + (129*r0_3 + 16512*((((r0_3 + 128*x0 + 8192*x1) // 24576) % 32)) + 1056768*((r0_3 + 128*x0 + 8192*x1) // 786432) + (((x0 + 64*x1) % 192))), r0_mask & tmp4, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp32 = tmp31.to(tl.float32)
        tmp33 = tl.load(in_ptr0 + (tl.broadcast_to(32*(((x0 + 64*x1) % 192)) + 8256*((x0 + 64*x1) // 6144) + ((((x0 + 64*x1) // 192) % 32)), [XBLOCK, R0_BLOCK])), r0_mask & tmp4, eviction_policy='evict_last', other=0.0)
        tmp34 = tl.load(in_ptr0 + (tl.broadcast_to(4096 + 8256*(x2 // 6144) + (((x2 // 192) % 32)), [XBLOCK, R0_BLOCK])), r0_mask & tmp6, eviction_policy='evict_last', other=0.0)
        ...
        tmp47 = tmp46 >= tmp1
        tmp48 = tmp46 < tmp3
        tmp49 = tl.load(in_ptr0 + (tl.broadcast_to(4128 + 32*(((63 + 64*x1) % 192)) + 8256*((63 + 64*x1) // 6144) + ((((63 + 64*x1) // 192) % 32)), [XBLOCK, R0_BLOCK])), r0_mask & tmp48, eviction_policy='evict_last', other=0.0)
        tmp50 = tmp46 >= tmp3
        tmp51 = tmp46 < tmp7
        tmp52 = tl.load(in_ptr0 + (tl.broadcast_to(8224 + 8256*((63 + 64*x1) // 6144) + ((((63 + 64*x1) // 192) % 32)), [XBLOCK, R0_BLOCK])), r0_mask & tmp50, eviction_policy='evict_last', other=0.0)
        tmp53 = tl.where(tmp48, tmp49, tmp52)
        tmp54 = tl.load(in_ptr0 + (tl.broadcast_to(4128 + 32*(((x0 + 64*x1) % 192)) + 8256*((x0 + 64*x1) // 6144) + ((((x0 + 64*x1) // 192) % 32)), [XBLOCK, R0_BLOCK])), r0_mask & tmp4, eviction_policy='evict_last', other=0.0)
        tmp55 = tl.load(in_ptr0 + (tl.broadcast_to(8224 + 8256*(x2 // 6144) + (((x2 // 192) % 32)), [XBLOCK, R0_BLOCK])), r0_mask & tmp6, eviction_policy='evict_last', other=0.0)
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp70 = tmp68 < tmp69
        tmp71 = tl.load(in_ptr3 + (tl.broadcast_to(4128 + 32*((x2 % 192)) + 8256*(x2 // 6144) + (((x2 // 192) % 32)), [XBLOCK, R0_BLOCK])), r0_mask & tmp70, eviction_policy='evict_last', other=0.0).to(tl.float32)
...
# Original path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/finite_fla_gpu.py:23
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/52/c52zd3sttlutebbdb33fyitiwwhhswdfdw5nuiessjhwsbldvgyb.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='maca', index=0, multi_processor_count=104, cc=80, major=8, regs_per_multiprocessor=131072, max_threads_per_multi_processor=2048, warp_size=64), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_14', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'F4337AF59E18A006A8110C1F352F0F4EB3D3AA586F5B0DB6F6A950B0D9B8F3BC', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': False, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 12681216}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/sh/cshjzmthzzp7ruwsa47gs6abodrkldjoptnds23pcxlbpqnh3smb.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_gpu_compiled_20260908_v1/inductor_cache/y7/cy7bmnmzi77yqzax42wp3zgd4ucy6au2k26i7tp6ft7dt4lueyl6.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf23 = empty_strided_cuda((192, 64), (64, 1), torch.float32)
        buf25 = empty_strided_cuda((192, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [triton_kernel_wrapper_mutation], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_poi_fused_0.run(arg4_1, buf25, 12288, stream=stream0)
        buf8 = empty_strided_cuda((2, 32, 192, 64), (393216, 12288, 64, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [a_19], Original ATen: [aten.constant_pad_nd]
        stream0 = get_raw_stream(0)
        triton_poi_fused_constant_pad_nd_1.run(arg7_1, buf8, 12288, 64, stream=stream0)
        del arg7_1
        buf0 = empty_strided_cuda((2, 32, 192, 128), (786432, 24576, 128, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [a_3], Original ATen: [aten.constant_pad_nd]
        stream0 = get_raw_stream(0)
        triton_poi_fused_constant_pad_nd_2.run(arg2_1, buf0, 12288, 128, stream=stream0)
        buf1 = empty_strided_cuda((2, 32, 192, 128), (786432, 24576, 128, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [a_1], Original ATen: [aten.constant_pad_nd]
        stream0 = get_raw_stream(0)
        triton_poi_fused_constant_pad_nd_3.run(arg0_1, buf1, 12288, 128, stream=stream0)
        del arg0_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_constant_pad_nd_2.run(arg3_1, buf3, 12288, 128, stream=stream0)
        del arg3_1
        buf6 = empty_strided_cuda((2, 32, 192, 128), (786432, 24576, 128, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [a_5], Original ATen: [aten.constant_pad_nd]
        stream0 = get_raw_stream(0)
        triton_poi_fused_constant_pad_nd_3.run(arg2_1, buf6, 12288, 128, stream=stream0)
        del arg2_1
        ...
        # Topologically Sorted Source Nodes: [a_23], Original ATen: [aten.constant_pad_nd]
        stream0 = get_raw_stream(0)
        triton_poi_fused_constant_pad_nd_4.run(arg9_1, buf9, 1572864, stream=stream0)
        del arg9_1
        buf51 = empty_strided_cuda((192, 64, 64), (4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [bmm_13], Original ATen: [aten.bmm]
        extern_kernels.bmm_dtype(reinterpret_tensor(buf0, (192, 64, 128), (8192, 128, 1), 0), reinterpret_tensor(buf0, (192, 128, 64), (8192, 1, 128), 0), out_dtype=torch.float32, out=buf51)
        ...
        buf49 = empty_strided_cuda((2, 129, 32, 128), (528384, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [contiguous_17], Original ATen: [aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_5.run(arg6_1, buf10, buf49, 8256, 128, stream=stream0)
        buf11 = reinterpret_tensor(buf9, (192, 128, 64), (8192, 1, 128), 0); del buf9  # reuse
        buf43 = empty_strided_cuda((192, 64, 128), (8192, 128, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [W, to_5, to_22], Original ATen: [aten.mul, aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_mul_6.run(arg6_1, buf10, buf11, buf43, 1572864, stream=stream0)
        ...
        buf18 = empty_strided_cuda((2, 32, 3, 128, 128), (1572864, 49152, 16384, 128, 1), torch.bfloat16)
        buf21 = empty_strided_cuda((192, 2), (2, 1), torch.float32)
        # Topologically Sorted Source Nodes: [reshape_12, reshape_13, float_8, float_9, mul_20, S], Original ATen: [aten.clone, aten._to_copy, aten.mul, aten.sum]
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_clone_mul_sum_7.run(arg10_1, arg11_1, buf13, buf18, buf21, 384, 8192, stream=stream0)
        del arg10_1
        del arg11_1
        buf22 = empty_strided_cuda((192, ), (1, ), torch.float32)
        # Topologically Sorted Source Nodes: [float_8, float_9, mul_20, S], Original ATen: [aten._to_copy, aten.mul, aten.sum]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_mul_sum_8.run(buf21, buf22, 192, 2, stream=stream0)
        del buf21
        buf44 = empty_strided_cuda((192, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [W, to_22, bmm_11], Original ATen: [aten.mul, aten._to_copy, aten.bmm]
        extern_kernels.bmm_dtype(buf43, reinterpret_tensor(buf13, (192, 128, 128), (16384, 1, 128), 0), out_dtype=torch.float32, out=buf44)
        ...
        extern_kernels.bmm_dtype(reinterpret_tensor(buf1, (192, 64, 128), (8192, 128, 1), 0), reinterpret_tensor(buf13, (192, 128, 128), (16384, 128, 1), 0), out_dtype=torch.float32, out=buf14)
        buf4 = reinterpret_tensor(buf43, (2, 32, 192, 128), (786432, 24576, 128, 1), 0); del buf43  # reuse
        buf15 = empty_strided_cuda((192, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [a_21, float_10, mul_21, sum_4], Original ATen: [aten.constant_pad_nd, aten._to_copy, aten.mul, aten.sum]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_constant_pad_nd_mul_sum_9.run(arg8_1, buf14, buf4, buf15, 12288, 128, stream=stream0)
        del arg8_1
        ...
        extern_kernels.bmm_dtype(reinterpret_tensor(buf4, (192, 64, 128), (8192, 128, 1), 0), reinterpret_tensor(buf13, (192, 128, 128), (16384, 1, 128), 0), out_dtype=torch.float32, out=buf30)
        del buf4
        buf16 = empty_strided_cuda((192, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [bmm_16], Original ATen: [aten.bmm]
        extern_kernels.bmm_dtype(reinterpret_tensor(buf6, (192, 64, 128), (8192, 128, 1), 0), reinterpret_tensor(buf13, (192, 128, 128), (16384, 128, 1), 0), out_dtype=torch.float32, out=buf16)
        buf50 = empty_strided_cuda((192, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [K0H], Original ATen: [aten.bmm]
        extern_kernels.bmm_dtype(reinterpret_tensor(buf0, (192, 64, 128), (8192, 128, 1), 0), reinterpret_tensor(buf13, (192, 128, 128), (16384, 128, 1), 0), out_dtype=torch.float32, out=buf50)
        del buf13
        buf19 = empty_strided_cuda((192, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [bmm_17], Original ATen: [aten.bmm]
        extern_kernels.bmm_dtype(reinterpret_tensor(buf0, (192, 64, 128), (8192, 128, 1), 0), reinterpret_tensor(buf18, (192, 128, 128), (16384, 128, 1), 0), out_dtype=torch.float32, out=buf19)
        buf35 = empty_strided_cuda((192, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [bmm_8], Original ATen: [aten.bmm]
        extern_kernels.bmm_dtype(reinterpret_tensor(buf3, (192, 64, 128), (8192, 128, 1), 0), reinterpret_tensor(buf18, (192, 128, 128), (16384, 1, 128), 0), out_dtype=torch.float32, out=buf35)
        del buf18
        buf32 = reinterpret_tensor(buf8, (192, 64, 64), (4096, 64, 1), 0); del buf8  # reuse
        buf45 = empty_strided_cuda((192, 64, 64), (4096, 64, 1), torch.bfloat16)
        buf52 = empty_strided_cuda((192, 64, 64), (4096, 64, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [sub, clamp_max, exp, causal, E0, mul_4, to_14, lower, mul_14, mul_15, to_24, mul_17, mul_18, to_28], Original ATen: [aten.sub, aten.clamp_max, aten.exp, aten.ge, aten.mul, aten._to_copy, aten.gt]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_clamp_max_exp_ge_gt_mul_sub_10.run(arg5_1, buf5, buf12, buf51, buf32, buf45, buf52, 12288, 64, stream=stream0)
        del buf51
        buf46 = empty_strided_cuda((192, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [lower, mul_14, mul_15, to_24, bmm_12], Original ATen: [aten.gt, aten.mul, aten._to_copy, aten.bmm]
        extern_kernels.bmm_dtype(buf45, reinterpret_tensor(buf0, (192, 64, 128), (8192, 128, 1), 0), out_dtype=torch.float32, out=buf46)
        buf33 = empty_strided_cuda((192, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [mul_4, to_14, bmm_7], Original ATen: [aten.mul, aten._to_copy, aten.bmm]
        ...
        # Topologically Sorted Source Nodes: [contiguous_15], Original ATen: [aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_11.run(arg5_1, buf30, buf33, buf34, 64, 16512, stream=stream0)
        buf24 = buf2; del buf2  # reuse
        buf37 = buf32; del buf32  # reuse
        buf40 = buf45; del buf45  # reuse
        # Topologically Sorted Source Nodes: [triton_kernel_wrapper_mutation, sub_1, clamp_max_1, exp_1, E1, mul_7, to_18, mul_9, to_20], Original ATen: [aten.sub, aten.clamp_max, aten.exp, aten.mul, aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_clamp_max_exp_mul_sub_12.run(buf24, buf5, buf7, buf12, arg5_1, buf37, buf40, 786432, stream=stream0)
        del buf12
        del buf5
        del buf7
        buf38 = buf33; del buf33  # reuse
        # Topologically Sorted Source Nodes: [mul_7, to_18, bmm_9], Original ATen: [aten.mul, aten._to_copy, aten.bmm]
        extern_kernels.bmm_dtype(buf37, reinterpret_tensor(buf1, (192, 64, 128), (8192, 128, 1), 0), out_dtype=torch.float32, out=buf38)
        del buf1
        del buf37
        buf41 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [mul_9, to_20, bmm_10], Original ATen: [aten.mul, aten._to_copy, aten.bmm]
        extern_kernels.bmm_dtype(buf40, reinterpret_tensor(buf6, (192, 64, 128), (8192, 128, 1), 0), out_dtype=torch.float32, out=buf41)
        del buf40
        buf53 = empty_strided_cuda((192, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [lower, mul_17, mul_18, to_28, bmm_14], Original ATen: [aten.gt, aten.mul, aten._to_copy, aten.bmm]
        extern_kernels.bmm_dtype(buf52, reinterpret_tensor(buf3, (192, 64, 128), (8192, 128, 1), 0), out_dtype=torch.float32, out=buf53)
        del buf52
        buf26 = empty_strided_cuda((192, 64), (64, 1), torch.float32)
        buf20 = empty_strided_cuda((192, 64), (64, 1), torch.float32)
        buf54 = empty_strided_cuda((192, 64), (64, 1), torch.float32)
        ...
        # Topologically Sorted Source Nodes: [W, mul_23, sum_5, float_11, mul_24, d, triton_kernel_wrapper_mutation, mul_6, mul_8, add_1, sub_3, float_5, mul_10, float_6, mul_11, sum_1, mul_12, add_2, mul_13, sub_4, dk, float_7, mul_16, r0, sub_6, mul_19, dbeta], Original ATen: [aten.mul, aten.sum, aten._to_copy, aten.add, aten.sub]
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_mul_sub_sum_13.run(buf47, buf28, arg5_1, buf3, buf19, arg6_1, buf10, buf16, arg1_1, buf50, buf53, buf38, buf41, buf6, buf44, buf46, buf26, buf20, buf54, buf27, 12288, 128, stream=stream0)
        del arg1_1
        del arg5_1
        del arg6_1
        del buf10
        ...
        # Topologically Sorted Source Nodes: [triton_kernel_wrapper_mutation], Original ATen: []
        stream0 = get_raw_stream(0)
        _finite_decay_scan_0.run(buf24, buf25, buf26, buf27, buf28, buf20, buf22, buf23, 64, 192, 1, 1, stream=stream0)
        del buf20
        del buf22
        del buf24
        del buf25
        ...
        del buf27
        del buf28
        buf48 = empty_strided_cuda((2, 129, 32, 128), (528384, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [contiguous_16], Original ATen: [aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_14.run(buf47, buf48, 1056768, stream=stream0)
        del buf47
        buf55 = empty_strided_cuda((2, 129, 32), (4128, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [contiguous_18], Original ATen: [aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_15.run(buf54, buf55, 258, 32, stream=stream0)
        del buf54
        buf56 = empty_strided_cuda((2, 129, 32), (4128, 32, 1), torch.float32)
        buf57 = empty_strided_cuda((2, 129, 32), (4128, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [contiguous_19, contiguous_20], Original ATen: [aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_16.run(buf23, arg4_1, buf56, buf57, 8256, stream=stream0)
        del arg4_1
        del buf23
    return (buf34, buf48, buf49, buf55, buf56, buf57, )
