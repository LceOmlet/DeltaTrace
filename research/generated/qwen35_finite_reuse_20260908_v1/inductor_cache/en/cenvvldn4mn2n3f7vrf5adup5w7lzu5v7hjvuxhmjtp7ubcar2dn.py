...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/kk/ckk2gpd4nyxosgsuaijxvc6k5pi4ppusal3tav5xyalyt6t2runp.py
...
# Graph fragment:
#   %triton_kernel_wrapper_mutation : [num_users=0] = call_function[target=torch.ops.higher_order.triton_kernel_wrapper_mutation](args = (), kwargs = {kernel_idx: 3, constant_args_idx: 1, grid: [(192, 1, 1)], tma_descriptor_metadata: {}, kwargs: {M: %sub_8, RawG0: %view_5, G0: %view_6, G1: %view_7, Bterm: %sub_7, Dterm: %sum_6, Sterm: %sum_3, Out: %permute_26}})
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/hh/chh4yuohwadqcwsobbw744xnfsoydqf2lcysu3dgwmdlfxtzixvu.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/mv/cmvg236ll6vfnhemr3u2aqihvr76i6bi4muntl4qqduhhdlt3zm6.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/zc/czceqoawimoy6rxsvcrwed3tqgzms7uqmyjs64i5o3llaew4bx6j.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/ix/cix7h5oxhnib3jh34dna3d6ial62h3f5kkcu6ialaqkqsjdhd57z.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/ed/cedp76ruqxzb5vhkhnkjfelpqwvnnjmkkycl2iwm2yblazli2p7s.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/7b/c7bapju3fc4dwcgb3ruwnd3nhvgcbynxyg55ldhuzixso4damg5g.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/hz/chz6qm76juh5veejf6ffrqhnwmjeljvpemsihpak6lbaeaox4eem.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/o5/co5ntnmtbgn2uous2wpp5ftdylj564d4n4pssu6ocuc3uwl7m6up.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/43/c43gwu47faye3axej4dp4kktav32su57wr3udaiieexs6sbsuowd.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/5k/c5knsp7rsmuqtvhhrlod3xj3zf5fy4bhuxezvk6refcabdjivib4.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/k3/ck37juyay67sveriy76dsyld6j3i2y2ddtvfdi4yf2lmen5ug4im.py
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/ne/cnehtmqcxu3y2h65lld6zrsuhmplsru2tqkiuio42mlfoptauaq2.py
...
# Original path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/finite_fla_gpu_baseline.py:23
...
# kernel path: ${ARTIFACT_ROOT}/codex_qwen35_finite_reuse_20260908_v1/inductor_cache/52/c52zd3sttlutebbdb33fyitiwwhhswdfdw5nuiessjhwsbldvgyb.py
