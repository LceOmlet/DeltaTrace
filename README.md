...
**最新结果：MAS条件错配已得到两条原样本的实际修复证据。** 仅第0层norm×SiLU改为对称分配：NI1 MAS 0.2888→0.1986、needle 92.1%→97.4%；MH1 MAS 0.3382→0.2695，两例RISE均改善。MH早段误差略退步，仍不宣称全部修复；正常路径成本待验。[MAS条件错配修复_第0层normgate_20260908.md](docs/history/MAS条件错配修复_第0层normgate_20260908.md)。
