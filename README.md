...
**最新定位：剩余MH错配已落到真实算子。** 同一正常向量与原评分下，中段FA第19层核心过估+4.99、第6层MLP过估+3.79；FLA/RMS存在反号补偿。先拆机制，不据此改原生后端或推广第0层修法。第0层已验证收益保留，整体Goal继续。[证据与下一步](docs/history/MAS剩余错配_第19层注意力与第6层MLP_20260908.md)。
