...
**最新结果：已实测端点分配影响，并拆清RMS与乘积误差。** NI1中段完整误差47.95→30.57，但早段10.26→11.56退步；平均候选未升为默认。MH1在原2%向量检查处停止，未扩跑。[核心定位_端点分配与RMS条件传播_20260908.md](docs/history/核心定位_端点分配与RMS条件传播_20260908.md)。
