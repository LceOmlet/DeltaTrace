...
**最新根因：Euclidean softmax候选整网验证失败，已停止推广。** MH原指标改善，但NI的MAS0.197→0.252；同删除集合的中段过估25.50→32.18，正负抵消加重。保留第0层已验证修复，整体Goal继续。[完整结果](docs/history/MAS整网验证_Euclidean_secant停止推广_20260908.md)。
