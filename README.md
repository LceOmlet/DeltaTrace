...
**最新结果：MAS差距已在四例重复，停止扩样并处理幅度失配。** 新增NI1/NI2/MH1的DT MAS均差于FT0–3；NI0–2 needle仍领先，RISE三例领先一例退步。FT及DT有限规则未改，工程下一步仍为官方logits_to_keep。[MAS三例补测与优化决策_20260908.md](docs/history/MAS三例补测与优化决策_20260908.md)。
