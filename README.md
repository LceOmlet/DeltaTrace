...
**最新结果：MLP内容优先候选三项退步，不升级；原DT默认和FT保持固定。** NI0冻结DT：needle37.5%、RISE0.177252、MAS0.346576；固定FT最好15%/0.187763/0.293977。下一步原模型logits_to_keep提效。[MLP内容优先消融与NI0原删除指标_20260908.md](docs/history/MLP内容优先消融与NI0原删除指标_20260908.md)。
