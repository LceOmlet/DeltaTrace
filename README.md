...
**最新根因：当前NI的最大剩余错配在第0层。** 同删除集合的中段总误差25.67中，第0层贡献+23.11；头部/种子−11.25等负项明确保留。下一步只拆该层当前内部传播；两种softmax候选停止扩大。[连续证据](docs/history/MAS当前NI根因定位_第0层仍为最大错配_20260908.md)。
