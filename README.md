...
**当前结论：迁移中的目标与FT控制规则变化是主要问题。** 同端点DT恢复全轨迹目标后，NI0从2.5%到40%；FT全轨迹诊断从5%到20%。下一步补齐当前官方e81b3be Both0—3，保留原core及历史版本，暂停删除评测扩跑。[Qwen35目标回归实测与FT版本语义核验_20260908.md](docs/history/Qwen35目标回归实测与FT版本语义核验_20260908.md)。
