...
**最新根因：四例 MAS 有改善、NI1 成本近似持平，但 MH0 的高 MAS 与大幅条件过估仍未解决；下一步补固定原版 FT0 同例对照。** [四样本连续证据与 NI1 实测成本](docs/history/MAS有限FLA端点平均_四样本连续证据与NI1成本确认_20260909.md)。Goal 未完成。
