...
**最新结果：MAS条件失配已定位到第0层FLA与融合norm-gate。** 两条原样本的向量/评分不变，完成粗层级与16项内部误差账本；下一候选针对单第0层端点顺序，尚未执行或宣布提升。[MAS根因定位与修法优先级_20260908.md](docs/history/MAS根因定位与修法优先级_20260908.md)。
