...
**最新根因：softmax有限传播候选已降低局部条件错配，整网待检验。** MH1第19层中段误差4.99→3.18、早段2.80→2.49；原P1内容系数保持。尚无新原指标结论，下一项仅两例完整比较。[结果与边界](docs/history/MAS修法局部验证_clean_softmax_secant_20260908.md)。
