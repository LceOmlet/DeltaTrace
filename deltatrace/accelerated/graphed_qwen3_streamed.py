...
def make_streamed_qwen3(root,model,library,library_sha256):
    ...
    Four metadata-only operands retain original layout and mutation checks
    without numerical storage. Complete finite math, precision, public FA
    and strict checks are inherited.
    """
    ...
    from qwen3_streamed_compact_graph import StreamedCompactFiniteGraphQwen3
    ...
    return StreamedCompactFiniteGraphQwen3(model,original.finite),{
